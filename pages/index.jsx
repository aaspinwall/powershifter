  ...
  return (
    <Layout seo={{ title: `WOP | Digital Agency` }}>
      ...
      <section className='bg-blue-600 gap-6 grid'>
        ...
        <p className={p}>
          <span className='font-bold'>Enterprise clients</span> work with us to
          augment their internal resources, taking advantage of our outside
          perspective and “drop-in” product expertise.
        </p>
        <p className={p}>
          <span className='font-bold'>Scale-ups</span> partner with us to
          validate their products and improve their user experience, making sure
          they're able to scale with growing needs.
        </p>
        <p className={p}>
          We'll provide your team with tried and tested processes that guarantee
          quality and speed to market. The biggest benefit? From enterprise to
          scale-ups, we get your product right the first time.
        </p>
      </section>
    </Layout>
  );
